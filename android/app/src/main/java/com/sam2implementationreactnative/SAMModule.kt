...
class SAMModule(private val reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext) {
    ...
    fun processImage(imageBase64: String, points: ReadableArray, labelId: Int, promise: Promise) {
        CoroutineScope(Dispatchers.Main).launch {
            try {
                ...
                val encoderResults = if (lastEncoderResults == null) {
                ...
                val maskBitmap = decoder.execute(
                    encoderResults,
                    pointsBuffer,
                    labelsBuffer,
                    1,
                ...
                val maskBase64 = android.util.Base64.encodeToString(maskBytes, android.util.Base64.DEFAULT)
